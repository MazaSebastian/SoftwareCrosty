...
const OptimizedSelect = ({
  ...
  // Memoizar el select para evitar re-renders innecesarios
  ...
  ), [localValue, handleChange, label, placeholder, disabled, required, error, className, memoizedOptions, isLoading, props]);
